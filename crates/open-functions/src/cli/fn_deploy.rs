//! `open-functions fn deploy` (T043): registers a function via the admin API and
//! follows the build to completion (polling `GET .../builds/{id}` and
//! printing the log — see `crates/open-functions/src/server/admin.rs` for why this is
